...
SEED_HISTORY_FILE="data/history_seed_2020_2026.csv.gz"
COURSE_FILE="data/course_structure.csv"
THRESHOLD_FILE="data/scenario_thresholds.csv"
...
SMARTRC_FILE="data/smartrc_ten_latest.csv"
SMARTRC_WEIGHT=0.30
